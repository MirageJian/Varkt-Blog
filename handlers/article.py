...
class ArticleHandler(BaseHandler):
    def get(self, *args, **kwargs):
        ...
        if not id_article:
            self.db.cursor.execute(
                "SELECT a.id,a.title,a.category,a.subhead,a.time,u.name as author FROM article a "
    ...
    def post(self, *args, **kwargs):
        ...
        self.db.cursor.execute(
            "UPDATE article SET id_user=%s,title=%s,subhead=%s,content=%s,category=%s,stick=%s,collection=%s,about=%s,"
            "time=%s WHERE id=%s", (
                id_user, body["title"], body["subhead"], body["content"], body["category"], body["stick"],
    ...
    def put(self, *args, **kwargs):
        ...
        body = self.json_decode(self.request.body)
        self.db.cursor.execute(
            "INSERT INTO article (id_user,title,subhead,content,category,stick,collection,about,time) "
